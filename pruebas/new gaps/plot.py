...
# Read the CSV file
df = pd.read_csv('output_grasp_1250_threads.csv')
...
# Create the boxplot
boxplot = ax.boxplot([df[df['threads'] == i]['milliseconds'] for i in range(1, 17)],
                     patch_artist=True,
...
# Customize the plot
ax.set_title(r'\textbf{Runtimes of the GRASP Metaheuristic with threads for Size 2 instances}', fontsize=16, pad=20)
...
plt.savefig('runtime_vs_threads_boxplot_larger_ticks_size2_16threads_!250.pdf', format='pdf', dpi=500, bbox_inches='tight')
