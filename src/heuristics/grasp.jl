...
function grasp(α, iters, instance)
    ...
    for i in 1:iters
        ...
        X = oppCostAssignmentGrasp(Y, instance, α)
        ...
        println("Mejora valor simple: ", mejora_peso_sim)
        ...
        println("Mejora valor intercambio: ", mejora_peso_int)
        after_ls = Dates.now()
...
function oppCostAssignmentGrasp(Y, instance::Types.Instance, α)
    D = copy(instance.D)
    P = instance.P
    S = instance.S
    B = instance.B
